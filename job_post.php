...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param("ssssssdss", $jobTitle, $jobDescription, $careerLevel, $companyName, $jobCategory, $qualifications, $proposedSalary, $requiredSkills, $applicationDeadline);
